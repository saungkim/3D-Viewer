...
public class ImgsFillDynamic : MonoBehaviour
{
    ...
    public void AllChildActivate(bool act)
    {
    ...
    public void CreateInstance()
    {
        ...
        GameObject canvas = transform.parent.parent.parent.gameObject;
        
        Instantiate(canvas).transform.GetChild(0).GetChild(0).GetChild(0).GetComponent<ImgsFillDynamic>().enabled = false;
