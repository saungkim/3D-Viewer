...
public class DefectConstructor : MonoBehaviour
{
    ...
    public class Defect
    {
        ...
        public string name; //���ڰ� ��ġ�� �� �̸�
        public string flawPrtbGrpCd; //��ġ��
        public string detailName; //���� ������ �� �̸�
        public string flawPrtbCd; //����ġ��
    ...
    public class View // ī�޶� ����
    {
        ...
        public Vector3 rotation; //ī�޶� ����
        public float fov; //ī�޶� fov
    }
